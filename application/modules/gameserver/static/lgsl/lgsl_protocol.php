...
//------------------------------------------------------------------------------------------------------------+
  ...
  function lgsl_query_live($type, $ip, $pos, $c_port, $q_port, $s_port, $request)
  {
//---------------------------------------------------------+
...
//  ARRAYS ARE SETUP IN ADVANCE
    ...
    $server = array(
    "b" => array("type" => $type, "ip" => $ip, "pos" => $pos, "c_port" => $c_port, "q_port" => $q_port, "s_port" => $s_port, "status" => 1),
...
//--------- PLEASE MAKE A DONATION OR SIGN THE GUESTBOOK AT GREYCUBE.COM IF YOU REMOVE THIS CREDIT -----------+
  ...
  {
    return "LGSL By Richard Perry</a> | <a href='https://github.com/tltneon/lgsl' target='_blank'>v 5.10.1"; // little dirty trick
  }
